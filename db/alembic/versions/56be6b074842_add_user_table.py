...
def upgrade() -> None:
    ...
    sa.Column('hashed_password', sa.String(), nullable=True, comment='Hashed password'),
    sa.Column('is_active', sa.Boolean(), nullable=False, comment='Is active'),
    sa.Column('last_login', sa.DateTime(timezone=True), nullable=True, comment='Last login'),
